          ...
          <form className="w-full">
            ...
            >
              <input
                ...
                className="w-full bg-slate-50 border-none focus:border-transparent focus:ring- outline-none sm:text-sm"
              />

              <button
                className="mt-1 w-full bg-gray-400 px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none hover:bg-gray-600 sm:mt-0 sm:w-auto sm:shrink-0"
              >
                Sign Up
              </button>
            </div>
